...
function GenReportFormHeader($prov) {
	...
	/*
	$rowsjudul[] = array (array ('data'=>'XSinkronisasi Kebijakan Pemerintah Kabupten Jepara dalam', 'width'=>'875px', 'colspan'=>'7', 'style' =>'border:none; font-weight:900; font-size:1.3em; text-align:center;'));
	$rowsjudul[] = array (array ('data'=>'Rancangan Peraturan Daerah tentang APBD Tahun Anggaran '. apbd_tahun() . ' dan', 'width'=>'875px', 'colspan'=>'7', 'style' =>'border:none; font-weight:900; font-size:1.3em; text-align:center;'));
	$rowsjudul[] = array (array ('data'=>'Rancangan Peraturan Kepala Daerah tentang Penjabaran APBD Tahun Anggaran '. apbd_tahun() . '', 'width'=>'875px', 'colspan'=>'7', 'style' =>'border:none; font-weight:900; font-size:1.3em; text-align:center;'));
	if ($prov=='prov')
		$rowsjudul[] = array (array ('data'=>'dengan Prioritas Pembangunan Provinsi', 'width'=>'875px', 'colspan'=>'7', 'style' =>'border:none; font-weight:900; font-size:1.3em; text-align:center;'));
	else
	...
	*/
	if ($prov=='prov')
		...
		$rowsjudul[] = array (array ('data'=>'Sinkronisasi Kebijakan Pemerintah Kabupten Jepara dengan Prioritas Pembangunan Nasional', 'width'=>'875px', 'colspan'=>'7', 'style' =>'border:none; font-weight:900; font-size:1.3em; text-align:center;'));
...
function GenReportFormContent($prov) {
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'No',  'width'=> '35px','rowspan'=>'2', 'style' => 'border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'Prioritas ' . $strbidang,  'width' => '200px','colspan'=>'2','rowspan'=>'2', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	*/
	...
	$headersrek[] = array (
						 ...
						 array('data' => '',  'width'=> '35px','style' => 'border-left: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => '',  'width' => '200px','colspan'=>'2','style' => 'border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'Uraian', 'width' => '370px', 'colspan'=>'3','style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'Alokasi Anggaran Belanja dalam Rancangan APBD',  'width' => '270px', 'colspan'=>'3', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'No',  'width'=> '35px','style' => 'border-left: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 array('data' => 'Prioritas ' . $strbidang,  'width' => '200px','colspan'=>'2','style' => 'border-right: 1px solid black; text-align:center;'),
						 array('data' => 'Program',  'width' => '280px','colspan'=>'2', 'style' => 'border-right: 1px solid black; text-align:center;'),
						 array('data' => 'Belanja Tidak',  'width' => '90px', 'style' => 'border-right: 1px solid black; text-align:center;'),
						 array('data' => 'Program',  'width' => '90px', 'style' => 'border-right: 1px solid black; text-align:center;'),
						 array('data' => 'Belanja Tidak',  'width' => '90px', 'style' => 'border-right: 1px solid black; text-align:center;'),
						 array('data' => 'Jumlah',  'width' => '90px', 'style' => 'border-right: 1px solid black; text-align:center;'),
						 );			
	$headersrek[] = array (

						 array('data' => '',  'width'=> '35px','style' => 'border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 array('data' => '',  'width' => '200px','colspan'=>'2','style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 array('data' => '',  'width' => '280px','colspan'=>'2', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 array('data' => 'Langsung',  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 array('data' => '(Rp)',  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 array('data' => 'Langsung (Rp)',  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 array('data' => '(Rp)',  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 );			
	//1) PRIORITAS
	$nomor =0;
	$tbl = 0;
	$tbtl = 0;
	$sql = 'select prioritasno, uraian from {prioritas' . $prov . '} order by prioritasno';
	$resultbid = db_query($sql);	
	if ($resultbid) 	{
		while ($databid = db_fetch_object($resultbid)) {
			...
			$where = sprintf(' where k.inaktif=0 and p.prioritasno=\'%s\'', db_escape_string($databid->prioritasno));
			$sql = 'select k.jenis,sum(k.total) totalbid from prioritas' . $prov . ' p inner join prioritasprogram' . $prov . ' pp on p.prioritasno= pp.prioritasno inner join kegiatanskpd k on pp.kodepro=k.kodepro ' . $where . ' group by k.jenis';
			//drupal_set_message($sql);
			$resultbidnum = db_query($sql);	
			if ($resultbid) 	{
			...
			$rowsrek[] = array (
								 array('data' => $nomor . '.',  'width'=> '35px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:center;'),
								 array('data' => $databid->uraian,  'width' => '200px','colspan'=>'2', 'style ' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
			...
			//2. URUSAN	
			$where = sprintf(' where p.prioritasno=\'%s\'', db_escape_string($databid->prioritasno));
			//$sql = 'select distinct p.* from prioritas' . $prov . ' p inner join prioritasprogram' . $prov . ' pp on p.prioritasno=pp.prioritasno ' . $where . ' order by p.kodebid,p.prioritasno';
			 
			$sql = 'select distinct u.* from prioritas' . $prov . ' p inner join prioritasprogram' . $prov . ' pp on p.prioritasno=pp.prioritasno inner join program pr on pp.kodepro=pr.kodepro inner join urusan u on pr.kodeu=u.kodeu  ' . $where . ' order by p.kodebid,p.prioritasno';
			...
			if ($resultu) {
				while ($datau = db_fetch_object($resultu)) {
					...
					$where = sprintf(' where k.inaktif=0 and pp.prioritasno=\'%s\' and p.kodeu=\'%s\'', db_escape_string($databid->prioritasno), db_escape_string($datau->kodeu));
					
					$sql = 'select k.jenis,sum(k.total) totalu from prioritasprogram' . $prov . ' pp inner join kegiatanskpd k on pp.kodepro=k.kodepro inner join program p on k.kodepro=p.kodepro ' . $where . ' group by k.jenis';
					//if ($datau->kodeu=='102') drupal_set_message($sql);
					$resunom = db_query($sql);	
					...
					if  (($unumbtl+$unumbl)>0) {
						...
						$rowsrek[] = array (
											 ...
											 array('data' => $datau->urusan,  'width' => '180px', 'style ' => ' border-right: 1px solid black; text-align:left;'),
						...
						$where = sprintf(' and k.inaktif=0 and pp.prioritasno=\'%s\' and pro.kodeu=\'%s\'', db_escape_string($databid->prioritasno), db_escape_string($datau->kodeu));

						//BTL
						$sql = 'select j.kodej, j.uraian, sum(agg.jumlah) totalbtl from anggperkeg agg inner join kegiatanskpd k on agg.kodekeg=k.kodekeg
						inner join prioritasprogram' . $prov . ' pp on k.kodepro=pp.kodepro
						inner join program pro on k.kodepro=pro.kodepro
						inner join jenis j on left(agg.kodero,3)=j.kodej
						where k.jenis=1 ' . $where . ' group by j.kodej, j.uraian';
						$resbtl = db_query($sql);
