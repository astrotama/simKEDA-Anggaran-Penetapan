...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		apbd_ExportPDF3_CF($topmargin,$topmargin, null, $htmlContent, $htmlFooter, false, $pdfFile, $hal1);
...
function GenReportForm($kodeuk, $lampiran, $judul,$revisi) {
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'Uraian',  'width' => '200px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	if ($resultakun) {
		while ($dataakun = db_fetch_object($resultakun)) {
			...
			$rowsrek[] = array (
								 ...
								 array('data' => $dataakun->uraian,  'width' => '200px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
								 ...
								 array('data' => apbd_fn1(apbd_hitungpersen($dataakun->jumlahx, $dataakun->jumlahxp)),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 3px solid black; text-align:right;font-weight:bold;'),
			...
			if ($resultkel) {
				while ($datakel = db_fetch_object($resultkel)) {
					$rowsrek[] = array (
										 ...
										 array('data' => $datakel->uraian,  'width' => '200px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
										 ...
										 array('data' => apbd_fn1(apbd_hitungpersen($datakel->jumlahx, $datakel->jumlahxp)),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 3px solid black; text-align:right;font-weight:bold;'),
										 array('data' => '',  'width' => '150px', 'style' => ' border-right: 1px solid black;'),									 
										 );		
					...
					if ($result) {
						while ($data = db_fetch_object($result)) {
							...
							$rowsrek[] = array (
												 array('data' => $kodedinas . '.000.000.' . ($data->kodej),  'width'=> '125px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
												 array('data' => ucfirst(strtolower($data->uraian)),  'width' => '200px', 'style' => ' border-right: 1px solid black; text-align:left;'),
												 ...
												 array('data' => apbd_fn1(apbd_hitungpersen($data->jumlahx, $data->jumlahxp)),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;' . $fontstyle),
												 array('data' => '',  'width' => '150px', 'style' => ' border-right: 1px solid black;'),
												 );
			...
			if ($resultkel) {
				while ($datakel = db_fetch_object($resultkel)) {
					$rowsrek[] = array (
										 ...
										 array('data' => apbd_fn1(apbd_hitungpersen($datakel->jumlahx, $datakel->jumlahxp)),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 2px solid black; text-align:right;font-weight:bold;'),
										 array('data' => '',  'width' => '150px', 'style' => ' border-right: 1px solid black;'),
										 );		
					...
					if ($result) {
						while ($data = db_fetch_object($result)) {
							...
							$rowsrek[] = array (
												 array('data' => $kodedinas . '.000.000.' . ($data->kodej),  'width'=> '125px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
												 array('data' => $uraianj,  'width' => '200px', 'style' => ' border-right: 1px solid black; text-align:left;'),
												 ...
												 array('data' => apbd_fn1(apbd_hitungpersen($data->jumlahx, $data->jumlahxp)),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;'),
												 array('data' => '',  'width' => '150px', 'style' => ' border-right: 1px solid black;'),
												 );
			...
			if ($resultkel) {
				while ($datakel = db_fetch_object($resultkel)) {
					$rowsrek[] = array (
										 ...
										 array('data' => apbd_fn1(apbd_hitungpersen($datakel->jumlahx, $datakel->jumlahxp)),  'width' => '100px', 'style' => 'border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
										 array('data' => '',  'width' => '150px', 'style' => ' border-right: 1px solid black;'),
										 );	
					...
					if ($resultpro) {
						while ($datapro = db_fetch_object($resultpro)) {
							$rowsrek[] = array (
												 ...
												 array('data' => strtoupper($datapro->uraian),  'width' => '200px', 'style' => ' border-right: 1px solid black; text-align:left;'),
												 ...
												 array('data' => apbd_fn1(apbd_hitungpersen($datapro->jumlahx, $datapro->jumlahxp)),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;'),
												array('data' => '',  'width' => '150px', 'style' => ' border-right: 1px solid black;'),
												 );	
							...
							if ($resultkeg) {
								while ($datakeg = db_fetch_object($resultkeg)) {
									$rowsrek[] = array (
														 ...
														 array('data' => strtoupper($datakeg->uraian),  'width' => '200px', 'style' => ' border-right: 1px solid black; text-align:left;'),
														 ...
														 array('data' => apbd_fn1(apbd_hitungpersen($datakeg->jumlahx, $datakeg->jumlahxp)),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;'),
														 array('data' => '',  'width' => '150px', 'style' => ' border-right: 1px solid black;'),
														 );	
									//REK JENIS
									...
									if ($resultrek) {
										while ($datarek = db_fetch_object($resultrek)) {
											$rowsrek[] = array (
																 array('data' => $kodedinas . '.' . $datapro->kodepro . '.' . $datakeg->nomorkeg . '.' . $datarek->kodej,  'width'=> '125px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
																 array('data' => ucfirst(strtolower($datarek->uraian)),  'width' => '200px', 'style' => ' border-right: 1px solid black; text-align:left;'),
																 ...
																 array('data' => apbd_fn1(apbd_hitungpersen($datarek->jumlahx, $datarek->jumlahxp)),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
																 array('data' => '',  'width' => '150px', 'style' => ' border-right: 1px solid black;'),
																 );												
										}
									}
	...
	if ($kodeuk=='81') {
		...
		$rowsrek[] = array (
							 ...
							 array('data' => 'PEMBIAYAAN',  'width' => '200px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
				...
				if ($result) {
					while ($data = db_fetch_object($result)) {
						...
						$rowsrek[] = array (
											 ...
											 array('data' => apbd_fn1(apbd_hitungpersen($datakel->jumlahx, $datakel->jumlahxp)),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
		...
		$rowsrek[] = array (
							 ...
							 array('data' => 'PEMBIAYAAN NETTO',  'width' => '200px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
	...
	$rowsrek[] = array (
						 ...
						 array('data' => apbd_fn1(apbd_hitungpersen($totalp-$totalb+$totalpm - $totalpk,$totalpp-$totalbp+$totalpm2 - $totalpk2)),  'width' => '100px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
...
function GenReportFormContent($kodeuk, $revisi) {
	...
	if ($kodeuk=='81') {
		...
		$rowsrek[] = array (
							 ...
							 array('data' => apbd_fn1(apbd_hitungpersen(($net_t[0][0]-$net_t[1][0]), ($net_t[0][1]-$net_t[1][1]))),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-top: 1px solid black; text-align:right;font-weight:bold;'),
							 );
...
function GenReportFormFooter($ttd) {
	if ($ttd==1) {
		...
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '200px',  'colspan'=>'2',  'style' => 'text-align:center'),
