...
function rekening_main() {
    ...
    if(isset($karg) && $karg!=null){
		...
		$sql = sprintf('select uraian from {jenis} where kodej=\'%s\' order by kodej', $karg);
		$res = db_query($sql);
		if ($data = db_fetch_object($res)) {
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'NOMOR', 'rowspan'=>'1', 'width'=> '60px', 'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'KODE', 'rowspan'=>'1', 'width' => '95px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'URAIAN', 'colspan'=>'1', 'width' => '400px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	if ($res) {
		...
		while ($data = db_fetch_object($res)) {
			...
			$rowsrek[] = array (
								 array('data' => $weight,  'width'=> '60px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:right;'),
								 array('data' => $data->kodeo,  'width' => '95px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
								 array('data' => $data->uraian,  'width' => '400px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
								 );
			//Rincian Obyek	................		
			...
			if ($ref) {
				...
				while ($dataf = db_fetch_object($ref)) {
					...
					$rowsrek[] = array (
								 ...
								 array('data' => '-'.$dataf->kodero,  'width' => '95px', 'style' => ' border-right: 1px solid black; text-align:left;'),
								 array('data' => $dataf->uraian,  'width' => '400px', 'style' => ' border-right: 1px solid black; text-align:left;'),
								 );
				}
			}
			//END Rincian Obyek ..............
	...
	apbd_ExportPDF2P(20, 20, $output, null, 'Rekening');
}
...
function GenReportFormContent($kodeuk, $tingkat, $revisi) {
	...
	if ($kodeuk  == '00') {	
		$rowslampiran[]= array (
							 array('data' => '',  'width'=> '565px', 'style' => 'border:none; text-align:left;'),
		...
		$rowslampiran[]= array (
							 array('data' => '',  'width'=> '585px',  'style' => 'border:none; text-align:left;'),
...
function GenReportFormFooter($kodeuk) {
	...
	if ($kodeuk == '00') {
		...
		$rowsfooter[] = array (
							 ...
							 array('data' => '',  'width' => '415px', 'style' => 'text-align:center;'),
							 );
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '435px',  'colspan'=>'2',  'style' => 'text-align:center'),
							 array('data' => $pimpinanjabatan,  'width' => '415px', 'style' => 'text-align:center;'),
							 );
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '435px',  'colspan'=>'2',  'style' => 'text-align:center'),
							 array('data' => '',  'width' => '415px', 'style' => 'text-align:center;'),
		...
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '435px',  'colspan'=>'2',  'style' => 'text-align:center'),
							 array('data' => $pimpinannama,  'width' => '415px', 'style' => 'text-align:center;'),
							 );
...
function rekening_form_submit($form, &$form_state) {
	...
	if($form_state['clicked_button']['#value'] == $form_state['values']['tampilkan']) 
        //$uri = 'apbd/laporan/apbd/rekening/' . $kodeuk . '/' . $tingkat . '/'. $topmargin . '/' . $hal1;
		$uri = 'apbd/laporan/apbd/rekening/' . $revisi . '/' . $kodeuk . '/' . $tingkat . '/'. $topmargin . '/' . $hal1;
	else	
		//$uri = 'apbd/laporan/apbd/rekening/' . $kodeuk . '/' . $tingkat . '/'. $topmargin . '/' . $hal1 . '/pdf' ;
		$uri = 'apbd/laporan/apbd/rekening/' . $revisi . '/' . $kodeuk . '/' . $tingkat . '/'. $topmargin . '/' . $hal1 . '/pdf' ;
