...
function kegiatanrevisi_editnew_form() {
	...
	*/
	...
	if ($perubahan=='1')		//UNTUK PERUBAHAN
		...
		$pquery = "select sumberdana from {sumberdanalt} where sumberdana in ('DAK', 'BANPROV') order by nomor" ;
...
function kegiatanrevisi_editnew_form_submit($form, &$form_state) {
	...
	$sql = sprintf("insert into {kegiatanrevisi} (kodekeg, nomorkeg, tahun, kodepro, kodeuk, kegiatan, jenis, plafon, sumberdana1, sumberdana1rp, 
