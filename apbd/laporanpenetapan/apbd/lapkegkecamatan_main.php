...
function GenReportForm($kodeuk) {
	...
	else if ($kecamatansql=='pakisaji')
		$whereuk = " and lower(k.lokasi) like '%aji%'";
	else
...
function GenReportFormHeader($kodeuk) {
	...
	$rowsjudul[] = array (array ('data'=> 'DAFTAR KEGIATAN APBD TAHUN ' . apbd_tahun(), 'width'=>'535px', 'colspan'=>'3', 'style' =>'border:none; font-weight:900; font-size:1.3em; text-align:center;'));
