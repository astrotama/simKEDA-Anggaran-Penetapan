...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
	...
	} else if (isset($exportpdf) && ($exportpdf=='pdf1'))  {
		//require_once('test.php');
		//myt();
		...
		$htmlHeader = GenReportFormHeader(1);
		$htmlContent = GenReportFormContent12();
		
		apbd_ExportPDF3_CF($topmargin,$topmargin, $htmlHeader, $htmlContent, '', false, $pdfFile, $hal1);
		
	} else if (isset($exportpdf) && ($exportpdf=='pdf2'))  {
		//require_once('test.php');
		//myt();
		...
		$htmlContent = GenReportFormContent34();
		$htmlFooter = GenReportFormFooter();
		
		apbd_ExportPDF3_CF($topmargin,$topmargin, '', $htmlContent, $htmlFooter, false, $pdfFile, $hal1);
...
function GenReportForm($print=0) {
	...
	$rowslampiran[]= array (
						 ...
						 array('data' => '', 'width' => '90px', 'style' => 'border:none; text-align:right;'),
	...
	$rowsjudul[] = array (array ('data'=>'REKAPITULASI BELANJA MENURUT URUSAN PEMERINTAHAN DAERAH - ORGANISASI - PROGRAM KEGIATAN', 'width'=>'810px', 'colspan'=>'5', 'style' =>'border:none; font-weight:900; font-size:1.3em; text-align:center;'));
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'KODE',  'width'=> '90px','rowspan'=>'2', 'style' => 'border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'URAIAN',  'width' => '360px','rowspan'=>'2', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	for ($u=0; $u<=2; $u++) {
		...
		$rowsrek[] = array (
							 array('data' => $u,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
							 array('data' => $ju,  'width' => '360px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
							 array('data' => apbd_fn($pegawai_ju),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 2px solid black; text-align:right;font-weight:bold;'),
							 array('data' => apbd_fn($barangjasa_ju),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 2px solid black; text-align:right;font-weight:bold;'),
							 array('data' => apbd_fn($modal_ju),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 2px solid black; text-align:right;font-weight:bold;'),
							 array('data' => apbd_fn($pegawai_ju+$barangjasa_ju+$modal_ju),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 2px solid black; text-align:right;font-weight:bold;'),
							 );		
		//2. URUSAN	
		...
		if ($result_u) {
			while ($datau = db_fetch_object($result_u)) {
				...
				//Render
				$rowsrek[] = array (
									 array('data' => $datau->kodeu,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
									 array('data' => $datau->urusan,  'width' => '360px', 'style' => ' border-right: 1px solid black; text-align:left; font-weight:bold;'),
									 array('data' => apbd_fn($pegawai_u),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
									 array('data' => apbd_fn($barangjasa_u),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black;text-align:right;font-weight:bold;'),
									 array('data' => apbd_fn($modal_u),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black;text-align:right;font-weight:bold;'),
									 array('data' => apbd_fn($pegawai_u+$barangjasa_u+$modal_u),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black;text-align:right;font-weight:bold;'),
									 );					
				...
				if ($result_uk) {
					while ($datauk = db_fetch_object($result_uk)) {
						...
						$rowsrek[] = array (
											 array('data' => $datau->kodeu . '.' . $datauk->kodedinas,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
											 array('data' => $datauk->namauk,  'width' => '360px', 'style' => ' border-right: 1px solid black; text-align:left;'),
											 array('data' => apbd_fn($pegawai_uk),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right; font-weight:bold;'),
											 array('data' => apbd_fn($barangjasa_uk),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right; font-weight:bold;'),
											 array('data' => apbd_fn($modal_uk),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
											 array('data' => apbd_fn($pegawai_uk+$barangjasa_uk+$modal_uk),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
											 );	
						//PROGRAM
						...
						if ($result_pro) {
							while ($datapro = db_fetch_object($result_pro)) {
								...
								$rowsrek[] = array (
													 array('data' => $datau->kodeu . '.' . $datauk->kodedinas . '.' . $datapro->kodepro,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
													 array('data' => $datapro->program,  'width' => '360px', 'style' => ' border-right: 1px solid black; text-align:left;'),
													 array('data' => apbd_fn($pegawai_pro),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;'),
													 array('data' => apbd_fn($barangjasa_pro),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;'),
													 array('data' => apbd_fn($modal_pro),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;'),
													 array('data' => apbd_fn($pegawai_pro+$barangjasa_pro+$modal_pro),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;'),
													 );	
								...
								if ($result_keg) {
									while ($datakeg = db_fetch_object($result_keg)) {
										...
										//Render
										$rowsrek[] = array (
															 array('data' => $datau->kodeu . '.' . $datauk->kodedinas . '.' . $datapro->kodepro . '.' . $datakeg->nomorkeg,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
															 array('data' => $datakeg->kegiatan,  'width' => '360px', 'style' => ' border-right: 1px solid black; text-align:left;'),
															 array('data' => apbd_fn($pegawai_keg),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
															 array('data' => apbd_fn($barangjasa_keg),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
															 array('data' => apbd_fn($modal_keg),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
															 array('data' => apbd_fn($pegawai_keg+$barangjasa_keg+$modal_keg),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
															 );	
	...
	$rowsrek[] = array (
						 ...
						 array('data' => apbd_fn($t_pegawai+$t_barangjasa+$t_modal),  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 );
...
function GenReportFormHeader($print=0) {
	...
	$rowsjudul[] = array (array ('data'=>'PEMERINTAH KABUPATEN JEPARA', 'width'=>'810px', 'colspan'=>'5', 'style' =>'border:none; font-weight:900; font-size:1em; text-align:center;'));
	$rowsjudul[] = array (array ('data'=>'REKAPITULASI BELANJA MENURUT URUSAN PEMERINTAHAN DAERAH - ORGANISASI - PROGRAM KEGIATAN', 'width'=>'810px', 'colspan'=>'5', 'style' =>'border:none; font-weight:900; font-size:1.3em; text-align:center;'));
	$rowsjudul[] = array (array ('data'=>'TAHUN ANGGARAN 2017', 'width'=>'810px', 'colspan'=>'5', 'style' =>'border:none; font-weight:900; font-size:1em; text-align:center;'));
	...
	*/
	...
	$rowsjudul[] = array (array ('data'=>'PEMERINTAH KABUPATEN JEPARA', 'width'=>'810px', 'colspan'=>'5', 'style' =>'border:none; font-weight:900; font-size:1em; text-align:center;'));
	$rowsjudul[] = array (array ('data'=>'REKAPITULASI BELANJA', 'width'=>'810px', 'colspan'=>'5', 'style' =>'border:none; font-weight:900; font-size:1.3em; text-align:center;'));
...
function GenReportFormContent() {
	...
	for ($u=1; $u<=4; $u++) {
		...
		if ($u==1)
			...
			$ju = 'URUSAN FUNGSI PENDUKUNG PEMERINTAHAN';
					...
					while ($datauk = db_fetch_object($result_uk)) {
						...
						if ($result_pro) {
							while ($datapro = db_fetch_object($result_pro)) {
								...
								//KEGIATAN
								$sql = sprintf(' and kodepro=\'%s\' and kodeuk=\'%s\'', db_escape_string($datapro->kodepro), db_escape_string($datauk->kodeuk));
								$sql = 'select kodekeg, kodepro, right(kodekeg,3) nomorkeg, kegiatan from {kegiatanskpd} where jenis=2 and total>0 and inaktif=0 ' . $sql . ' order by kodepro, nomorkeg';													 
								$result_keg = db_query($sql);
								if ($result_keg) {
									while ($datakeg = db_fetch_object($result_keg)) {
	...
	$rowsrek[] = array (
						 array('data' => 'TOTAL',  'width'=> '450px',  'colspan'=>'2',  'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 array('data' => apbd_fn($t_pegawai),  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 array('data' => apbd_fn($t_barangjasa),  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 array('data' => apbd_fn($t_modal),  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 array('data' => apbd_fn($t_pegawai+$t_barangjasa+$t_modal),  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
...
function GenReportFormContent12() {
...
function GenReportFormContent34() {
	...
	$sql = 'select left(a.kodero,3) kode, sum(a.jumlah) anggaran from {anggperkeg} a inner join 
			{kegiatanskpd} k on a.kodekeg=k.kodekeg where k.jenis=2 and k.inaktif=0 group by left(a.kodero,3)';
	//drupal_set_message($sql);
	$res = db_query($sql);	
	if ($res) 	{
		while ($data = db_fetch_object($res)) {
			if ($data->kode == '521') 
				$t_pegawai = $data->anggaran;
			else if ($data->kode == '522') 
				$t_barangjasa = $data->anggaran;
			else
				$t_modal = $data->anggaran;
		}				
	}	
...
function lampiran4_form () {
	...
	$form['formdata']['cetak1'] = array (
		'#type' => 'submit',
		'#value' => 'Cetak #1'
	);
	$form['formdata']['cetak2'] = array (
		'#type' => 'submit',
		'#value' => 'Cetak #2'
	);
...
function lampiran4_form_submit($form, &$form_state) {
	...
	else if($form_state['clicked_button']['#value'] == $form_state['values']['cetak1']) 
		$uri = 'apbd/laporanpenetapan/apbd/lampiran4/' . $topmargin . '/' . $hal1 . '/pdf1' ;
	else if($form_state['clicked_button']['#value'] == $form_state['values']['cetak2']) 
		$uri = 'apbd/laporanpenetapan/apbd/lampiran4/' . $topmargin . '/' . $hal1 . '/pdf2' ;
	else
