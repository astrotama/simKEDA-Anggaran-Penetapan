...
function GenReportForm($print=0) {
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'PENDAPATAN', 'width' => '110px', 'rowspan'=>'2','style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'ANGGARAN BELANJA',  'width' => '330px', 'colspan'=>'3', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),

						 );	
	$headersrek[] = array (

						 array('data' => 'TIDAK LANGSUNG',  'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'LANGSUNG',  'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'TOTAL BELANJA',  'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 );						 
	...
	for ($u=1; $u<=4; $u++) {
		...
		$rowsrek[] = array (
							 ...
							 array('data' => apbd_fn($pendapatanju),  'width' => '110px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
							 array('data' => apbd_fn($btlju),  'width' => '110px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
							 array('data' => apbd_fn($blju),  'width' => '110px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
							 array('data' => apbd_fn($btlju+$blju),  'width' => '110px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
							 );		
		//2. URUSAN	
			...
			while ($datau = db_fetch_object($resultu)) {
				...
				if (($pendapatanu+$btlu+$blu) >0) {
					...
					$rowsrek[] = array (
										 ...
										 array('data' => apbd_fn($pendapatanu),  'width' => '110px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
										 array('data' => apbd_fn($btlu),  'width' => '110px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
										 array('data' => apbd_fn($blu),  'width' => '110px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
										 array('data' => apbd_fn($btlu+$blu),  'width' => '110px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
										 );					
					...
					if ($resultuk) {	
						while ($datauk = db_fetch_object($resultuk)) {
							...
							$rowsrek[] = array (
												 ...
												 array('data' => apbd_fn($pendapatanuk),  'width' => '110px', 'style' => ' border-right: 1px solid black; text-align:right;'),
												 array('data' => apbd_fn($btluk),  'width' => '110px', 'style' => ' border-right: 1px solid black; text-align:right;'),
												 array('data' => apbd_fn($bluk),  'width' => '110px', 'style' => ' border-right: 1px solid black; text-align:right;'),
												 array('data' => apbd_fn($btluk+$bluk),  'width' => '110px', 'style' => ' border-right: 1px solid black; text-align:right;'),
												 );					
	...
	$rowsrek[] = array (
						 array('data' => 'TOTAL',  'width'=> '330px',  'colspan'=>'2',  'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 array('data' => apbd_fn($t_pendapatan),  'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 array('data' => apbd_fn($t_btl),  'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 array('data' => apbd_fn($t_bl),  'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 array('data' => apbd_fn($t_btl+$t_bl),  'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 );
...
function GenReportFormHeader($print=0) {
	...
	$rowslampiran[]= array (
						 array('data' => '',  'width'=> '560px','colspan'=>'3',  'style' => 'border:none; text-align:left;'),
						 array('data' => 'LAMPIRAN II', 'width' => '50px', 'style' => 'border:none; text-align:right;font-size: 75%;'),
						 array('data' => ': PERATURAN DAERAH KABUPATEN JEPARA', 'width' => '250px', 'colspan'=>'2',  'style' => 'border:none;text-align:left;font-size: 75%;'),
						 );
	$rowslampiran[]= array (
						 array('data' => '',  'width'=> '510px', 'colspan'=>'3', 'style' => 'border:none; text-align:left;'),
	...
	$rowsjudul[] = array (array ('data'=>'RINGKASAN APBD MENURUT URUSAN PEMERINTAHAN DAERAH DAN ORGANISASI', 'width'=>'810px', 'colspan'=>'5', 'style' =>'border:none; font-weight:900; font-size:1.3em; text-align:center;'));
...
function GenReportFormContent() {
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'TIDAK LANGSUNG',  'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 array('data' => 'LANGSUNG',  'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 array('data' => 'TOTAL BELANJA',  'width' => '110px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 );						 
