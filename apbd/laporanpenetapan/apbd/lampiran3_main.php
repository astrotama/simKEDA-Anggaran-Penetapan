...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		$output .= GenReportFormContent($kodeuk);
		return $output;
	}
...
function GenReportForm($kodeuk, $lampiran, $judul) {
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'Kode',  'width'=> '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	if ($resultakun) {
		while ($dataakun = db_fetch_object($resultakun)) {
			...
			$rowsrek[] = array (
								 array('data' => $kodedinas . '.'. $dataakun->kodea,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
			...
			if ($resultkel) {
				while ($datakel = db_fetch_object($resultkel)) {
					$rowsrek[] = array (
										 array('data' => $kodedinas . '.000.000.' . $datakel->kodek,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
					...
					if ($result) {
						while ($data = db_fetch_object($result)) {
							...
							$rowsrek[] = array (
												 array('data' => $kodedinas . '.000.000.' . ($data->kodej),  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
												 array('data' => ucfirst(strtolower($data->uraian)),  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;'),
												 array('data' => apbd_fn($data->jumlahx),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
												 );
	...
	if ($resultakun) {
		while ($dataakun = db_fetch_object($resultakun)) {
			...
			if ($resultkel) {
				while ($datakel = db_fetch_object($resultkel)) {
					$rowsrek[] = array (
										 array('data' => $kodedinas . '.' . $datakel->kodek,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
										 array('data' => $datakel->uraian,  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
										 array('data' => apbd_fn($datakel->jumlahx),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black;text-align:right;font-weight:bold;'),
										 );	
					...
					inner join {program} p on k.kodepro=p.kodepro where k.inaktif=0 and k.total>0  and k.kodeuk=\'%s\' and k.jenis=2';
					$fsql = sprintf($sql, db_escape_string($kodeuk));
					...
					if ($resultpro) {
						while ($datapro = db_fetch_object($resultpro)) {
							$rowsrek[] = array (
												 array('data' => $kodedinas . '.' . $datapro->kodepro,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
							...
							if ($resultkeg) {
								while ($datakeg = db_fetch_object($resultkeg)) {
									$rowsrek[] = array (
														 array('data' => $kodedinas . '.' . $datapro->kodepro . '.' . $datakeg->nomorkeg,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
														 array('data' => strtoupper($datakeg->uraian),  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;'),
														 array('data' => apbd_fn($datakeg->jumlahx),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;'),
														 );	
									//REK JENIS
									...
									if ($resultrek) {
										while ($datarek = db_fetch_object($resultrek)) {
											$rowsrek[] = array (
																 array('data' => $kodedinas . '.' . $datapro->kodepro . '.' . $datakeg->nomorkeg . '.' . $datarek->kodej,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
																 array('data' => ucfirst(strtolower($datarek->uraian)),  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;'),
																 array('data' => apbd_fn($datarek->jumlahx),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
																 );												
										}
									}
								}
	...
	if ($kodeuk=='81') {
		...
		$rowsrek[] = array (
							 array('data' => $kodedinas . '.6',  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
		...
		$rowsrek[] = array (
							 array('data' => '',  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
							 array('data' => 'PEMBIAYAAN NETTO',  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
							 array('data' => apbd_fn($totalpm - $totalpk),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-top: 1px solid black; text-align:right;font-weight:bold;'),
							 );
...
function GenReportFormHeader($kodeuk, $lampiran, $judul) {
	...
	if ($lampiran =='1') {
		$rowslampiran[]= array (
							 array('data' => '',  'width'=> '265px', 'style' => 'border:none; text-align:left;'),
	...
	$rowskegiatan[]= array (
						 array('data' => 'Urusan',  'width'=> '90px', 'style' => 'text-align:left;'),
						 array('data' => ':', 'width' => '15px', 'style' => 'text-align:right;'),
						 array('data' => $urusan, 'width' => '430',   'style' => 'text-align:left;'),
						 );
	$rowskegiatan[]= array (
						 array('data' => 'OPD',  'width'=> '90px', 'style' => 'text-align:left;'),
						 array('data' => ':',  'width' => '15px', 'style' => 'text-align:right;'),
						 array('data' => $skpd,  'width' => '430',  'style' => 'text-align:left;'),					 
						);
...
function GenReportFormContent($kodeuk) {
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'Kode',  'width'=> '90px', 'style' => 'border-left: 1px solid black;border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'Uraian',  'width' => '335px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'Jumlah',  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	$where = ' where k.jumlah>0 and k.kodeuk=\'%s\'';
	$sql = 'select a.kodea,a.uraian,sum(jumlah) jumlahx from {anggperuk} k  inner join {anggaran} a on mid(k.kodero,1,1)=a.kodea ' . $where;
	$fsql = sprintf($sql, db_escape_string($kodeuk));
	$fsql .= ' group by a.kodea,a.uraian order by a.kodea';
	...
	if ($resultakun) {
		...
		$rowsrek[] = array (
							 array('data' =>'',  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:60%;'),
							 array('data' => '',  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;font-size:60%;'),
							 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;font-size:60%;'),
							 );
		...
		while ($dataakun = db_fetch_object($resultakun)) {
			...
			$rowsrek[] = array (
								 array('data' => $kodedinas . '.'. $dataakun->kodea,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
								 array('data' => $dataakun->uraian,  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;font-size:125%;'),
								 array('data' => apbd_fn($dataakun->jumlahx),  'width' => '90px', 'style' => ' border-right: 1px solid black; border-bottom: 2px solid black; text-align:right;font-weight:bold;'),
								 );
				
			$sql = 'select x.kodek,x.uraian,sum(jumlah) jumlahx from {anggperuk} k inner join {kelompok} x on mid(k.kodero,1,2)=x.kodek where k.jumlah>0 and k.kodeuk=\'%s\' and mid(k.kodero,1,1)=\'%s\'';
			$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($dataakun->kodea));
			$fsql .= ' group by x.kodek,x.uraian order by x.kodek';
			...
			if ($resultkel) {
				while ($datakel = db_fetch_object($resultkel)) {
					...
					$sql = 'select j.kodej,j.uraian,sum(jumlah) jumlahx from {anggperuk} k inner join {jenis} j on mid(k.kodero,1,3)=j.kodej where k.jumlah>0 and k.kodeuk=\'%s\' and mid(k.kodero,1,2)=\'%s\'';
					$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datakel->kodek));
					$fsql .= ' group by j.kodej,j.uraian order by j.kodej';
	...
	//****BELANJA
	$totalb = 0;
	$where = ' and k.jumlah>0 and g.kodeuk=\'%s\'';
	$sql = 'select a.kodea,a.uraian,sum(k.jumlah) jumlahx from {anggperkeg} k  inner join {anggaran} a on mid(k.kodero,1,1)=a.kodea inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where g.inaktif=0 ' . $where;
	$fsql = sprintf($sql, db_escape_string($kodeuk));
	$fsql .= ' group by a.kodea,a.uraian order by a.kodea';
	...
	if ($resultakun) {
		...
		while ($dataakun = db_fetch_object($resultakun)) {
			...
			//KELOMPOK - BTL
			$sql = 'select x.kodek,x.uraian,sum(jumlah) jumlahx from {anggperkeg} k inner join {kelompok} x on mid(k.kodero,1,2)=x.kodek inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where k.jumlah>0 and g.inaktif=0 and k.jumlah>0 and g.kodeuk=\'%s\' and left(k.kodero,2)=\'%s\' and mid(k.kodero,1,1)=\'%s\'';
			$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string('51'), db_escape_string($dataakun->kodea));
			$fsql .= ' group by x.kodek,x.uraian order by x.kodek';
			...
			if ($resultkel) {
				while ($datakel = db_fetch_object($resultkel)) {
					...
					//JENIS
					$sql = 'select j.kodej,j.uraian,sum(jumlah) jumlahx from {anggperkeg} k inner join {jenis} j on mid(k.kodero,1,3)=j.kodej  inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where g.inaktif=0 and k.jumlah>0 and g.kodeuk=\'%s\' and left(k.kodero,2)=\'%s\' and mid(k.kodero,1,2)=\'%s\'';
			...
			//KELOMPOK - BL
			$sql = 'select x.kodek,x.uraian,sum(k.jumlah) jumlahx from {anggperkeg} k inner join {kelompok} x on mid(k.kodero,1,2)=x.kodek inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where g.inaktif=0 and k.jumlah>0 and g.kodeuk=\'%s\' and left(k.kodero,2)=\'%s\'';
			$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string('52'));
			$fsql .= ' group by x.kodek,x.uraian order by x.kodek';			
			$resultkel = db_query($fsql); 
			if ($resultkel) {
				...
				$rowsrek[] = array (
									 array('data' =>'',  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:30%;'),
									 array('data' => '',  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;font-size:30%;'),
									 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;font-size:30%;'),
									 );
				...
				while ($datakel = db_fetch_object($resultkel)) {
					...
					inner join {program} p on k.kodepro=p.kodepro where k.inaktif=0 and k.kodeuk=\'%s\' and k.total>0 and k.jenis=2';
					$fsql = sprintf($sql, db_escape_string($kodeuk));
					$fsql .= ' group by k.kodepro,p.program order by k.kodepro';			
					$resultpro = db_query($fsql);
					if ($resultpro) {
						while ($datapro = db_fetch_object($resultpro)) {
							...
							$rowsrek[] = array (
												 array('data' =>'',  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:20%;'),
												 array('data' => '',  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;font-size:20%;'),
												 array('data' => '',  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;font-size:20%;'),
												 );
						
							$rowsrek[] = array (
												 array('data' => $kodedinas . '.' . $datapro->kodepro,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
												 array('data' => strtoupper($datapro->uraian),  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
												 array('data' => apbd_fn($datapro->jumlahx),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
												 );	
							
							//KEGIATAN 
							$sql = 'select kodekeg, right(kodekeg, 3) nomorkeg, kegiatan uraian, total jumlahx from {kegiatanskpd} k where k.inaktif=0 and k.total>0 and k.kodeuk=\'%s\' and k.kodepro=\'%s\' and k.jenis=2';
							$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datapro->kodepro));
							$fsql .= ' order by k.kodekeg';			
							$resultkeg = db_query($fsql);
							if ($resultkeg) {
								while ($datakeg = db_fetch_object($resultkeg)) {
									if ($datakeg->jumlahx>0) {
										$rowsrek[] = array (
															 array('data' => $kodedinas . '.' . $datapro->kodepro . '.' . $datakeg->nomorkeg,  'width'=> '90px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
															 array('data' => strtoupper($datakeg->uraian),  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;'),
															 array('data' => apbd_fn($datakeg->jumlahx),  'width' => '90px', 'style' => ' border-right: 1px solid black; text-align:right;'),
										...
										//REK JENIS
										$sql = 'select j.kodej,j.uraian,sum(jumlah) jumlahx from {anggperkeg} k inner join {jenis} j on mid(k.kodero,1,3)=j.kodej  inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where k.jumlah>0 and g.kodeuk=\'%s\' and g.kodekeg=\'%s\'';
										$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datakeg->kodekeg));
										$fsql .= ' group by j.kodej,j.uraian order by j.kodej';
										$resultrek = db_query($fsql);
										if ($resultrek) {
	...
	$rowsrek[] = array (
						 array('data' => 'SURPLUS / DEFISIT',  'width'=> '425px',  'colspan'=>'2',  'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 array('data' => apbd_fn($totalp-$totalb+$totalpm - $totalpk),  'width' => '90px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 );	
