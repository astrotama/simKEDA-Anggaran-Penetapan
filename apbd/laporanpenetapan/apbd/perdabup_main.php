...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		$output .= GenReportFormContent($kodeuk, $perdabup);
		return $output;
	}
...
function GenReportForm($kodeuk, $perdabup, $lampiran, $judul) {
	...
	if ($lampiran==1) {
		...
		*/
		...
		$rowslampiran[]= array (
							 array('data' => '',  'width'=> '460px', 'style' => 'border:none; text-align:left;'),
	...
	$rowskegiatan[]= array (
						 array('data' => 'OPD',  'width'=> '150px', 'style' => ' text-align:left;'),
					...
					if ($resultj) {
						while ($dataj = db_fetch_object($resultj)) {
							...
							$rowsrek[] = array (
												 ...
												 array('data' => $strjenis,  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;'),
								...
								if ($resulto) {
									while ($datao = db_fetch_object($resulto)) {
										...
										$rowsrek[] = array (
															 ...
															 array('data' => $datao->uraian,  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;'),
										...
										if ($result) {
											while ($dataro = db_fetch_object($result)) {
												$rowsrek[] = array (
																	 ...
																	 array('data' => ucfirst(strtolower($dataro->uraian)),  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;font-style: italic;'),
									...
									while ($datao = db_fetch_object($resulto)) {
										...
										if ($result) {
											while ($dataro = db_fetch_object($result)) {
												$rowsrek[] = array (
																 array('data' => $kodedinas . '.000.000.' . substr_replace($dataro->kodero, '.', 3,0),  'width'=> '125px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
																 array('data' => $dataro->uraian,  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;font-style: italic;'),
																 array('data' => apbd_fn($dataro->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
																 array('data' => '',  'width' => '250px', 'style' => ' border-right: 1px solid black;'),
															 );		
												...
												if (($dataj->kodej == 516) or ($dataj->kodej == 517) ) {
													//KEGIATAN
													$sql = 'select k.kodekeg,k.kegiatan,a.jumlah from {kegiatanskpd} k inner join {anggperkeg} a on k.kodekeg=a.kodekeg where a.jumlah>0 and k.inaktif=0 and a.kodero=\'%s\' order by k.kegiatan';
													...
													if ($resultdetil) {
														while ($datadetil = db_fetch_object($resultdetil)) {
															$rowsrek[] = array (
																			 ...
																			 array('data' => '- ' . $datadetil->kegiatan,  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;font-style: italic;font-weight:100;'),
						...
						while ($datapro = db_fetch_object($resultpro)) {
							...
							if ($resultkeg) {
								while ($datakeg = db_fetch_object($resultkeg)) {
									$nomorkeg = substr($datakeg->kodekeg,-3);
									$rowsrek[] = array (
														 array('data' => $kodedinas . '.' . $datapro->kodepro . '.' . $nomorkeg,  'width'=> '125px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
														 array('data' => strtoupper($datakeg->uraian),  'width' => '335px', 'style' => ' border-right: 1px solid black; text-align:left;font-style: italic;'),
														 ...
														 array('data' => 'Lokasi x : ' . $datakeg->kodekeg . 'x' .  str_replace('||',', ', '' . $datakeg->lokasi),  'width' => '250px', 'style' => ' border-right: 1px solid black;font-weight:lighter;font-style: italic;'),
													);	
									$sdindex =0;
									//REK JENIS
	...
	$rowsrek[] = array (
						 array('data' => 'SURPLUS / DEFISIT',  'width'=> '460px',  'colspan'=>'2',  'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
...
function GenReportFormHeader($kodeuk, $perdabup, $lampiran, $judul) {
	...
	if ($lampiran==1) {
		if ($perdabup=='perda') {
			...
			$strlamp = 'DAERAH KABUPATEN';
			$rowslampiran[]= array (
								 array('data' => '',  'width'=> '515px', 'style' => 'border:none; text-align:left;'),
								 array('data' => 'LAMPIRAN', 'width' => '50px', 'style' => 'border:none; text-align:right;font-size: 75%;'),
								 array('data' => 'PERATURAN ' . $strlamp . ' JEPARA', 'width' => '250px', 'colspan'=>'2',  'style' => 'border:none;text-align:left;font-size: 75%;'),
								 );
	...
	if ($judul==1) {
		...
		$rowsjudul[] = array (array ('data'=>'PENJABARAN ANGGARAN PENDAPATAN DAN BELANJA DAERAH', 'width'=>'810px', 'colspan'=>'5', 'style' =>'border:none; font-weight:900; font-size:1.3em; text-align:center;'));
	...
	$rowskegiatan[]= array (
						 array('data' => 'OPD',  'width'=> '120px', 'style' => ' text-align:left;'),
...
function GenReportFormContent($kodeuk, $perdabup) {
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'KODE',  'width'=> $kode_width, 'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'URAIAN',  'width' => $uraian_width,  'colspan' =>'2', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'JUMLAH',  'width' => '100px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	if ($resultakun) {
		...
		$rowsrek[] = array (
							 array('data' => '',  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:60%;'),
							 array('data' => '',  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;font-size:60%;'),
							 array('data' => '',  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;font-size:60%;'),
							 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;font-size:60%;'),
						 );		
	
		while ($dataakun = db_fetch_object($resultakun)) {
			$totalp += $dataakun->jumlahx;
			$rowsrek[] = array (
								 array('data' => $kodedinas . '.' . $dataakun->kodea,  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
								 array('data' => $dataakun->uraian,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;font-size:125%;'),
								 array('data' => apbd_fn($dataakun->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 3px solid black; text-align:right;font-weight:bold;'),
			...
			if ($resultkel) {
				while ($datakel = db_fetch_object($resultkel)) {
					if ($perdabup == 'perbup') {
						$rowsrek[] = array (
											 array('data' => '',  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:40%;'),
											 array('data' => '',  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-size:40%;'),
											 array('data' => '',  'width' => '100px', 'style' => ' border-right: 1px solid black;text-align:right;font-size:40%;'),
											 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;font-size:40%;'),									 
											);		
					}
					$rowsrek[] = array (
										 array('data' => $kodedinas . '.000.000.' . $datakel->kodek,  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
										 array('data' => $datakel->uraian,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;bold;font-size:110%;'),
										 array('data' => apbd_fn($datakel->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 2px solid black;text-align:right;font-weight:bold;'),
										 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),									 
										);		

					//JENIS
					$sql = 'select j.kodej,j.uraian,sum(k.jumlah) jumlahx from {anggperuk} k inner join {jenis} j on mid(k.kodero,1,3)=j.kodej where k.kodeuk=\'%s\' and mid(k.kodero,1,2)=\'%s\' and k.jumlah>0';
					$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datakel->kodek));
					$fsql .= ' group by j.kodej,j.uraian order by j.kodej';
					...
					if ($resultj) {
						while ($dataj = db_fetch_object($resultj)) {
							...
							if ($perdabup == 'perda') {
								...
								$fontstyle = 'font-weight:bold;';
								$rowsrek[] = array (
													 array('data' => '',  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:20%;'),
													 array('data' => '',  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-size:20%;'),
													 array('data' => '',  'width' => '100px', 'style' => ' border-right: 1px solid black;text-align:right;font-size:20%;'),
													 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;font-size:20%;'),									 
													);		
							}
							...
							$rowsrek[] = array (
												 array('data' => $kodedinas . '.000.000.' . ($dataj->kodej),  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
												 array('data' => $strjenis,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;'),
												 array('data' => apbd_fn($dataj->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;' . $fontstyle),
												 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),
											 );
							if ($perdabup == 'perbup') {
								//OBYEK
								$sql = 'select o.kodeo,o.uraian,sum(k.jumlah) jumlahx from {anggperuk} k inner join {obyek} o on mid(k.kodero,1,5)=o.kodeo where k.kodeuk=\'%s\' and o.kodej=\'%s\' and k.jumlah>0';
								$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($dataj->kodej));
								$fsql .= ' group by o.kodeo,o.uraian order by o.kodeo';
								//drupal_set_message( $fsql);
								$resulto = db_query($fsql);
								if ($resulto) {
									while ($datao = db_fetch_object($resulto)) {
										$rowsrek[] = array (
															 array('data' => $kodedinas . '.000.000.' . substr_replace($datao->kodeo, '.', 3,0),  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
															 array('data' => $datao->uraian,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;'),
															 array('data' => apbd_fn($datao->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;'),
															 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),
														);	
										//RINCIAN OBYEK
										$sql = 'select ro.kodero,ro.uraian,k.jumlah jumlahx, k.ketrekening from {anggperuk} k inner join {rincianobyek} ro on k.kodero=ro.kodero where k.kodeuk=\'%s\' and ro.kodeo=\'%s\' and k.jumlah>0';
										$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datao->kodeo));
										$fsql .= ' order by ro.kodero';
										//drupal_set_message( $fsql);
										$result = db_query($fsql);
										if ($result) {
											while ($dataro = db_fetch_object($result)) {
												...
												if ($dataro->jumlahx==0)
													...
													$ketrekening = $dataro->ketrekening;
												
												$rowsrek[] = array (
																	 array('data' => $kodedinas . '.000.000.' . get_rek_rincian($dataro->kodero),  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
																	 array('data' => $dataro->uraian,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-style: italic;'),
																	 array('data' => apbd_fn($dataro->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
																	 array('data' => $ketrekening,  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;font-weight:lighter;font-style: italic;'),
																);												
											}
										}
		...
		while ($dataakun = db_fetch_object($resultakun)) {
			...
			if ($resultkel) {
				while ($datakel = db_fetch_object($resultkel)) {
					...
					$rowsrek[] = array (
										 array('data' => $kodedinas . '.000.000.' . $datakel->kodek,  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
										 array('data' => $datakel->uraian,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;font-size:110%;'),
										 array('data' => apbd_fn($datakel->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 2px solid black; text-align:right;font-weight:bold;'),
										 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),
									 );		

					//JENIS
					$sql = 'select j.kodej,j.uraian,sum(k.jumlah) jumlahx from {anggperkeg} k inner join {jenis} j on mid(k.kodero,1,3)=j.kodej  inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where g.inaktif=0 and g.kodeuk=\'%s\' and j.kodek=\'%s\' and k.jumlah>0';
					$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datakel->kodek));
					$fsql .= ' group by j.kodej,j.uraian order by j.kodej';
					...
					if ($resultj) {
						while ($dataj = db_fetch_object($resultj)) {
							...
							if ($perdabup == 'perbup') {
								//OBYEK
								$sql = 'select o.kodeo,o.uraian,sum(k.jumlah) jumlahx from {anggperkeg} k inner join {obyek} o on mid(k.kodero,1,5)=o.kodeo inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where g.inaktif=0 and g.kodeuk=\'%s\' and o.kodej=\'%s\' and k.jumlah>0';
								$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($dataj->kodej));
								$fsql .= ' group by o.kodeo,o.uraian order by o.kodeo';
								...
								if ($resulto) {
									while ($datao = db_fetch_object($resulto)) {
										...
										//RINCIAN OBYEK
										$sql = 'select ro.kodero,ro.uraian,sum(k.jumlah) jumlahx from {anggperkeg} k inner join {rincianobyek} ro on k.kodero=ro.kodero inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where g.inaktif=0 and g.kodeuk=\'%s\' and ro.kodeo=\'%s\' and k.jumlah>0';
										$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datao->kodeo));
										$fsql .= ' group by ro.kodero,ro.uraian order by ro.kodero';
										...
										if ($result) {
											while ($dataro = db_fetch_object($result)) {
												...
												if (($dataj->kodej == 516) or ($dataj->kodej == 517) ) {
													//KEGIATAN
													$sql = 'select k.kodekeg,k.kegiatan,a.jumlah from {kegiatanskpd} k inner join {anggperkeg} a on k.kodekeg=a.kodekeg where a.jumlah>0 and a.kodero=\'%s\' and k.inaktif=0 order by k.kegiatan';
													$fsql = sprintf($sql, db_escape_string($dataro->kodero));
													...
													if ($resultdetil) {
														while ($datadetil = db_fetch_object($resultdetil)) {
															$rowsrek[] = array (
																			 array('data' => '',  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
																			 array('data' => '-',  'width' => '15px',  'style' => ' text-align:right;font-style: italic;'),
																			 array('data' => $datadetil->kegiatan,  'width' => '320px', 'style' => ' border-right: 1px solid black; text-align:left;font-style: italicfont-weight:100;'),
																			 array('data' => apbd_fn($datadetil->jumlah),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;font-weight:100;'),
																			 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),
																		 );		
			...
			//KELOMPOK - BL
			$sql = 'select x.kodek,x.uraian,sum(k.jumlah) jumlahx from {anggperkeg} k inner join {kelompok} x on mid(k.kodero,1,2)=x.kodek inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where g.inaktif=0 and g.kodeuk=\'%s\' and left(k.kodero,2)=\'%s\'';
			$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string('52'));
			$fsql .= ' group by x.kodek,x.uraian order by x.kodek';			
			$resultkel = db_query($fsql);
			if ($resultkel) {
				...
				$rowsrek[] = array (
									 array('data' => '',  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:30%;'),
									 array('data' => '',  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;font-size:30%;'),
									 array('data' => '',  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;font-size:30%;'),
									 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;font-size:30%;'),
								 );	
				
				while ($datakel = db_fetch_object($resultkel)) {
					$rowsrek[] = array (
										 array('data' => $kodedinas . '.' . $datakel->kodek ,  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
										 array('data' => $datakel->uraian,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;font-size:110%;'),
										 array('data' => apbd_fn($datakel->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 2px solid black;text-align:right;font-weight:bold;'),
										 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),
									 );	
					...
					//PROGRAM
					$sql = 'select k.kodepro, p.program uraian,sum(k.total) jumlahx from {kegiatanskpd} k 
					inner join {program} p on k.kodepro=p.kodepro where k.inaktif=0 and k.total>0 and k.kodeuk=\'%s\' and k.jenis=2  and k.total>0';
					$fsql = sprintf($sql, db_escape_string($kodeuk));
					$fsql .= ' group by k.kodepro,p.program order by k.kodepro';			
					$resultpro = db_query($fsql);
					if ($resultpro) {
						while ($datapro = db_fetch_object($resultpro)) {
							...
							$rowsrek[] = array (
												 array('data' => $kodedinas . '.' . $datapro->kodepro,  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
												 array('data' => strtoupper($datapro->uraian),  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
												 array('data' => apbd_fn($datapro->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
												 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),
											 );	
							$rowsrek[] = array (
												 array('data' => '',  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;font-size:2%;'),
												 array('data' => '',  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;font-size:2%;'),
												 array('data' => '',  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-size:2%;'),
												 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;font-size:2%;'),
											 );	
							
							//KEGIATAN
							$sql = 'select kodekeg, right(kodekeg,3) nomorkeg, kegiatan uraian, total jumlahx, lokasi, sumberdana1 from {kegiatanskpd} where inaktif=0 and total>0 and kodeuk=\'%s\' and kodepro=\'%s\' and jenis=2';
							$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datapro->kodepro));
							...
							if ($resultkeg) {
								while ($datakeg = db_fetch_object($resultkeg)) {
									$startkeg = true;
									if (($datakeg->sumberdana1 =='DAK') or ($datakeg->sumberdana1 =='BANPROV') or ($datakeg->sumberdana1 =='DBH CHT') or ($datakeg->sumberdana1 =='DBHCHT'))  {
									...
									$lokasi =str_replace('undefined', '' , $datakeg->lokasi);
									
									if ($lokasi=='') $lokasi = 'Kabupaten Jepara';
									
									$rowsrek[] = array (
														 array('data' => $kodedinas . '.' . $datapro->kodepro . '.' . $datakeg->nomorkeg,  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
														 array('data' => strtoupper($datakeg->uraian),  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-style: italic;'),
														 array('data' => apbd_fn($datakeg->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black;border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
														 ...
														 array('data' => str_replace('||',', ', $lokasi),  'width' => '175px',  'style' => ' border-right: 1px solid black;font-weight:lighter;font-style: italic;'),
													);	
									//REK JENIS
									$sql = 'select j.kodej,j.uraian,sum(k.jumlah) jumlahx from {anggperkeg} k inner join {jenis} j on mid(k.kodero,1,3)=j.kodej  inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where g.kodeuk=\'%s\' and g.kodekeg=\'%s\'  and k.jumlah>0';
									$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datakeg->kodekeg));
									$fsql .= ' group by j.kodej,j.uraian order by j.kodej';
									$resultj = db_query($fsql);
									if ($resultj) {
										while ($dataj = db_fetch_object($resultj)) {
											...
											$rowsrek[] = array (
																 array('data' => $kodedinas . '.' . $datapro->kodepro . '.' . $datakeg->nomorkeg . '.' . $dataj->kodej,  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
																 array('data' => $strjenis,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;'),
																 array('data' => apbd_fn($dataj->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;' . $fontstyle),
																 //array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),
											...
											if ($perdabup=='perbup') {
												//OBYEK
												$sql = 'select o.kodeo,o.uraian,sum(k.jumlah) jumlahx from {anggperkeg} k inner join {obyek} o on mid(k.kodero,1,5)=o.kodeo inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where g.kodeuk=\'%s\' and g.kodekeg=\'%s\' and o.kodej=\'%s\' and k.jumlah>0';
												$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datakeg->kodekeg), db_escape_string($dataj->kodej));
												$fsql .= ' group by o.kodeo,o.uraian order by o.kodeo';
												//drupal_set_message( $fsql);											
												$resulto = db_query($fsql);
												if ($resulto) {
													while ($datao = db_fetch_object($resulto)) {
														$rowsrek[] = array (
																			 array('data' => $kodedinas . '.' . $datapro->kodepro . '.' . $datakeg->nomorkeg . '.' . substr_replace($datao->kodeo, '.', 3,0),  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
																			 array('data' => $datao->uraian,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;'),
																			 array('data' => apbd_fn($datao->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black;text-align:right;'),
																			 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),
																		);	
														...
														//RINCIAN OBYEK
														$sql = 'select ro.kodero,ro.uraian,k.jumlah jumlahx from {anggperkeg} k inner join {rincianobyek} ro on k.kodero=ro.kodero inner join {kegiatanskpd} g on k.kodekeg=g.kodekeg where g.kodeuk=\'%s\' and g.kodekeg=\'%s\' and ro.kodeo=\'%s\' and k.jumlah>0';
														$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datakeg->kodekeg), db_escape_string($datao->kodeo));
														$fsql .= ' group by ro.kodero,ro.uraian order by ro.kodero';
														//drupal_set_message( $fsql);
														$result = db_query($fsql);
														if ($result) {
															while ($dataro = db_fetch_object($result)) {
																$rowsrek[] = array (
																					 array('data' => $kodedinas . '.' . $datapro->kodepro . '.' . $datakeg->nomorkeg . '.' . get_rek_rincian($dataro->kodero),  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
																					 array('data' => $dataro->uraian,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-style: italic;'),
																					 array('data' => apbd_fn($dataro->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
																					 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),
																				);															
	...
	if ($kodeuk=='81') {
		...
		$rowsrek[] = array (
							 array('data' => $kodedinas . '.6',  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
							 array('data' => 'PEMBIAYAAN',  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
							 array('data' => '',  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
							 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),
							 );
		...
		if ($resultkel) {
			while ($datakel = db_fetch_object($resultkel)) {
				...
				$rowsrek[] = array (
									 array('data' => $kodedinas . '.000.000.' . $datakel->kodek,  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
									 array('data' => $datakel->uraian,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
									 array('data' => apbd_fn($datakel->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 2px solid black;text-align:right;font-weight:bold;'),
									 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),									 
									);		
						...
						if ($perdabup == 'perbup') {
							...
							if ($resulto) {
								while ($datao = db_fetch_object($resulto)) {
									...
									//RINCIAN OBYEK
									$sql = 'select ro.kodero,ro.uraian,jumlah jumlahx, k.ketrekening from {anggperda} k inner join {rincianobyek} ro on k.kodero=ro.kodero where ro.kodeo=\'%s\'';
									$fsql = sprintf($sql, db_escape_string($datao->kodeo));
									$fsql .= ' order by ro.kodero'; 
									//drupal_set_message( $fsql);
									$result = db_query($fsql);
									if ($result) {
										while ($dataro = db_fetch_object($result)) {
											$rowsrek[] = array (
																 array('data' => $kodedinas . '.000.000.' . substr_replace($dataro->kodero, '.', 3,0),  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
																 array('data' => $dataro->uraian,  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:left;font-style: italic;'),
																 array('data' => apbd_fn($dataro->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
		...
		$rowsrek[] = array (
							 array('data' => '',  'width'=> $kode_width, 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
							 array('data' => 'PEMBIAYAAN NETTO',  'width' => $uraian_width,  'colspan' =>'2', 'style' => ' border-right: 1px solid black; text-align:right;font-weight:bold;'),
							 array('data' => apbd_fn($totalpm - $totalpk),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-top: 1px solid black;text-align:right;font-weight:bold;'),
							 array('data' => '',  'width' => '250px', 'colspan' =>'3', 'style' => ' border-right: 1px solid black;'),									 
							);				
	}
	...
	$rowsrek[] = array (
						 array('data' => 'SURPLUS / DEFISIT',  'width'=> '460px',  'colspan'=>'3',  'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 array('data' => apbd_fn($totalp + $totalpm - $totalb - $totalpk),  'width' => '100px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
...
function get_rek_rincian($kodero) {
	return substr($kodero, 0,3) . '.' . substr_replace(substr($kodero, 3), '.', 2,0);	
}
