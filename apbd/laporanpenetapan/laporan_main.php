...
function laporan_main($arg=NULL) {
	...
	*/
	...
	if ((isSuperuser()) or (isUserview())) {
		$rows[] = array (array('data' => 'LAPORAN RKA-SKPD',  'colspan'=>'3', 'style' => 'font-weight:bold;'),
						array('data' => 'LAPORAN RKA-PPKD',  'colspan'=>'4', 'style' => 'font-weight:bold;'),
		...
		$rows[] = array (array('data' => "<img src='/files/lap2.png'>", 'valign'=>'top'),
						...
						array('data' => l('Ringkasan DPA-PPKD', 'apbd/laporanpenetapan/dpa/ringkasananggaranppkd'), 'valign'=>'top'),
						array('data' => 'Menampilkan ringkasan RKA/DPA-PPKD', 'valign'=>'top'),		
		...
		$rows[] = array (array('data' => "<img src='/files/lap2.png'>", 'valign'=>'top'),
						...
						'apbd/pendapatanppkd/print/rka'), 'valign'=>'top'),
						array('data' => l('DPA-PPKD Pendapatan', 
						'apbd/pendapatanppkd/print/dpa'), 'valign'=>'top'),
						array('data' => 'Menampilkan rincian RKA/DPA-PPKD Pendapatan', 'valign'=>'top'),
		...
		$rows[] = array (array('data' => "<img src='/files/lap2.png'>", 'valign'=>'top'),
						...
						'apbd/kegiatanppkd/print/rka'), 'valign'=>'top'),
						array('data' => l('DPA-PPKD Belanja', 
						'apbd/kegiatanppkd/print/dpa'), 'valign'=>'top'),
						array('data' => 'Menampilkan RKA/DPA-PPKD Belanja', 'valign'=>'top'),
		...
		$rows[] = array (array('data' => "<img src='/files/lap2.png'>", 'valign'=>'top'),
						...
						'apbd/pembiayaan/print/61/rka'), 'valign'=>'top'),
						array('data' => l('DPA-PPKD Penerimaan Pembiayaan', 
						'apbd/pembiayaan/print/61/dpa'), 'valign'=>'top'),
						array('data' => 'Menampilkan RKA/DPA-PPKD Penerimaan Pembiayaan', 'valign'=>'top'),
		...
		$rows[] = array (array('data' => "<img src='/files/lap2.png'>", 'valign'=>'top'),
						...
						'apbd/pembiayaan/print/62/rka'), 'valign'=>'top'),
						array('data' => l('RPA-PPKD Pengeluaran Pembiayaan', 
						'apbd/pembiayaan/print/62/dpa'), 'valign'=>'top'),
						array('data' => 'Menampilkan RKA/DPA-PPKD Pengeluaran Pembiayaan', 'valign'=>'top'),
