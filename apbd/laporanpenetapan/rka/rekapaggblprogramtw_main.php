	...
	*/
	...
	if ($resultpro) {
		while ($datapro = db_fetch_object($resultpro)) {
			...
			//KEGIATAN
			$sql = 'select kodekeg,right(k.kodekeg,3) nomorkeg, lokasi,programtarget,kegiatan,sumberdana1,sumberdana2,total,tw1,tw2,tw3,tw4 
...
function GenReportFormHeader($kodeuk, $tipedok) {
	...
	if ($tipedok=='dpa') {
		...
		$rowskegiatan[]= array ( 
							 ...
							 array('data' => 'R E K A P I T U L A S I', 'width' => '300px', 'colspan'=>'4', 'style' => 'border-right: 1px solid black; border-top: 2px solid black; font-size:1.3em; text-align:center;'),
							 array('data' => 'FORMULIR', 'width' => '175',  'style' => 'border-right: 1px solid black; border-top: 2px solid black;font-size:1.3em; text-align:center;'),
							 );
		$rowskegiatan[]= array ( 
							 ...
							 array('data' => 'B E L A N J A  -  L A N G S U N G', 'width' => '300px', 'colspan'=>'4', 'style' => 'border-right: 1px solid black; font-size:1.3em; text-align:center;'),
							 array('data' => 'DPA-SKPD 2.2', 'width' => '175',  'style' => 'border-right: 1px solid black; font-size:1.3em; text-align:center;'),
							 );
		$rowskegiatan[]= array ( 
							 array('data' => '',  'width'=> '90px', 'style' => 'border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; font-size:1.3em; text-align:center;'),
							 array('data' => 'PEMERINTAH KABUPATEN JEPARA', 'width' => '310px', 'colspan'=>'3', 'style' => 'border-right: 1px solid black;border-bottom: 1px solid black; font-size:1.3em; text-align:center;'),
							 array('data' => 'MENURUT PROGRAM DAN KEGIATAN', 'width' => '300px', 'colspan'=>'4', 'style' => 'border-right: 1px solid black; border-bottom: 1px solid black; font-size:1.3em; text-align:center;'),
							 array('data' => $tahun, 'width' => '175',  'style' => 'border-right: 1px solid black; border-bottom: 1px solid black; font-size:1.3em; text-align:center;'),
							 );
		/*					 
		$rowskegiatan[]= array ( 
							 array('data' => 'DOKUMEN PELAKSANAAN ANGGARAN',  'width'=> '450px', 'colspan'=>'4', 'style' => 'border-left: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; ; text-align:center;font-size:1.2em; '),
							 array('data' => 'REKAPITULASI BELANJA LANGSUNG', 'width' => '300px', 'colspan'=>'5', 'style' => 'border-right: 1px solid black; border-top: 2px solid black; font-size:1.2em; text-align:center;'),
							 array('data' => 'FORMULIR', 'width' => '125',  'style' => 'border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
							 );
		$rowskegiatan[]= array ( 
							 array('data' => 'SATUAN KERJA PERANGKAT DAERAH',  'width'=> '450px', 'colspan'=>'4', 'style' => 'border-left: 1px solid black; border-right: 1px solid black; ; font-size:1.2em; text-align:center;'),
							 array('data' => 'MENURUT PROGRAM DAN KEGIATAN', 'width' => '300px', 'colspan'=>'5', 'style' => 'border-right: 1px solid black; font-size:1.2em; text-align:center;'),
							 array('data' => 'DPA-SKPD 2.2', 'width' => '125',  'style' => 'border-right: 1px solid black; text-align:center;'),
							 );
		$rowskegiatan[]= array ( 
							 array('data' => 'PEMERINTAH KABUPATEN JEPARA',  'width'=> '450px', 'colspan'=>'4', 'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; font-size:1.2em; text-align:center;'),
							 array('data' => '', 'width' => '300px', 'colspan'=>'5', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; font-size:1.2em; text-align:center;'),
...
function GenReportFormContent($kodeuk, $tipedok) {
	...
	*/
	...
	//if ($kodeuk=='35')
	//	$where = ' where k.inaktif=0 and k.jenis=2 and k.kodeuk=\'%s\' and k.kodepro=\'%s\'';
	//else
		$where = ' where k.inaktif=0 and k.total>0 and k.jenis=2 and k.kodeuk=\'%s\'';
	$sql = 'select p.kodepro,p.program,sum(k.total) jumlahx,sum(k.tw1) tw1x,sum(k.tw2) tw2x,
			sum(k.tw3) tw3x,sum(k.tw4) tw4x from {kegiatanskpd} k left join {program} p 
			on k.kodepro=p.kodepro ' . $where;
	$fsql = sprintf($sql, db_escape_string($kodeuk), '047');
	$fsql .= ' group by p.kodepro,p.program order by p.kodepro';
	...
	if ($resultpro) {
		while ($datapro = db_fetch_object($resultpro)) {
			...
			//KEGIATAN
			$sql = 'select kodekeg,right(kodekeg,3) nomorkeg, lokasi,programtarget,kegiatan,total,tw1,tw2,tw3,tw4,sumberdana1,sumberdana2
					from {kegiatanskpd} where inaktif=0 and total>0 and jenis=2 and kodeuk=\'%s\' and kodepro=\'%s\'';
			$fsql = sprintf($sql, db_escape_string($kodeuk), db_escape_string($datapro->kodepro));
			$fsql .= ' order by kodekeg';
