...
function ringkasananggaranppkd_form_submit($form, &$form_state) {
	...
	$dpa = $form_state['values']['dpa'];
	$topmargin = $form_state['values']['topmargin'];

	if($form_state['clicked_button']['#value'] == $form_state['values']['tampilkan']) 
        $uri = 'apbd/laporanpenetapan/' . $dpa . '/ringkasananggaranppkd/' . $tingkat . '/'. $topmargin . '/' ;
	else	
		$uri = 'apbd/laporanpenetapan/' . $dpa . '/ringkasananggaranppkd/' . $tingkat . '/'. $topmargin . '/pdf' ;
