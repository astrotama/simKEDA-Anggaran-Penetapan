...
drupal_add_css('files/css/kegiatancam.css');
	...
	if (isset($exportpdf) && ($exportpdf=='pdf'))  {
		...
		$output .= GenReportFormContent($kodeuk, $tingkat, $tipedok);
		return $output;
	}
...
function GenReportForm($kodeuk, $tingkat, $tipedok) {
	...
	if ($kodeuk=='00') {
		...
		$rowsrek[] = array (
							 array('data' => 'PEMBIAYAAN NETTO',  'width'=> '775px',  'colspan'=>'5',  'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
		...
		$rowsrek[] = array (
							 array('data' => 'SISA LEBIH ANGGARAN TAHUN BERKENAAN',  'width'=> '775px',  'colspan'=>'5',  'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
...
function GenReportFormHeader($kodeuk, $tipedok) {
	...
	if ($tipedok=='dpa') {
		...
		$rowskegiatan[]= array ( 
						 array('data' => 'PEMERINTAH',  'width'=> '300px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'RINGKASAN DOKUMEN PELAKSANAAN ANGGARAN', 'width' => '475px','colspan'=>'4', 'style' => 'border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'DPA-SKPD', 'width' => '100px',  'style' => 'border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 );
		$rowskegiatan[]= array ( 
						 ...
						 array('data' => 'SATUAN KERJA PERANGKAT DAERAH', 'width' => '475px', 'colspan'=>'4','style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
						 array('data' => $tahun, 'width' => '100px',  'style' => 'border-bottom: 1px solid black; border-right: 1px solid black;  text-align:center;'),
						 );  
	...
	$rowskegiatan[]= array (
					 ...
					 array('data' => ':', 'width' => '15px', 'style' => 'text-align:right;'),
					 array('data' => $urusan, 'width' => '710',  'colspan'=>'4', 'style' => 'border-right: 1px solid black; text-align:left;'),
					 );
	$rowskegiatan[]= array (
					 array('data' => 'Organisasi',  'width'=> '150px', 'style' => 'border-left: 1px solid black; text-align:left;'),
					 array('data' => ':',  'width' => '15px', 'style' => 'text-align:right;'),
					 array('data' => $skpd,  'width' => '710', 'colspan'=>'4', 'style' => 'border-right: 1px solid black; text-align:left;'),					 
					);
	$rowskegiatan[]= array (
...
function GenReportFormContent($kodeuk, $tingkat, $tipedok) {
	...
	$headersrek[] = array (
						 ...
						 array('data' => 'Kode',  'width'=> '60px', 'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'Uraian',  'width' => '715px','colspan'=>'4', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
						 array('data' => 'Jumlah',  'width' => '100px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 2px solid black; text-align:center;'),
	...
	if ($resultakun) {
		while ($dataakun = db_fetch_object($resultakun)) {
			...
			$rowsrek[] = array (
								 array('data' => $dataakun->kodea,  'width'=> '60px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
								 array('data' => $dataakun->uraian, 'width' => '715px', 'colspan'=>'4',  'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
								 array('data' => apbd_fn($dataakun->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 2px solid black; text-align:right;font-weight:bold;'),
								 );
			...
			if ($resultkel) {
				while ($datakel = db_fetch_object($resultkel)) {
					$rowsrek[] = array (
										 array('data' => $datakel->kodek,  'width'=> '60px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
										 array('data' => $datakel->uraian, 'width' => '715px', 'colspan'=>'4',  'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
										 array('data' => apbd_fn($datakel->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; border-bottom: 1px solid black; text-align:right;font-weight:bold;'),
										 );		
					...
					if ($result) {
						while ($data = db_fetch_object($result)) {
							...
							$rowsrek[] = array (
												 array('data' => ($data->kodej),  'width'=> '60px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
												 array('data' => $uraianj, 'width' => '715px', 'colspan'=>'4',  'style' => ' border-right: 1px solid black; text-align:left;'),
												 array('data' => apbd_fn($data->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;' . $bold),
												 );
							...
							if ($tingkat>=4) {
								...
								if ($resulto) {
									while ($datao = db_fetch_object($resulto)) {
										$rowsrek[] = array (
															 array('data' => apbd_format_rek_obyek($datao->kodeo),  'width'=> '60px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
															 array('data' => $datao->uraian, 'width' => '715px', 'colspan'=>'4',  'style' => ' border-right: 1px solid black; text-align:left;'),
															 array('data' => apbd_fn($datao->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;'),
															 );	
										...
										if ($tingkat>=5) {
											...
											if ($resultro) {
												while ($dataro = db_fetch_object($resultro)) {
													$rowsrek[] = array (
																		 array('data' => apbd_format_rek_rincianobyek($dataro->kodero),  'width'=> '60px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
																		 array('data' => $dataro->uraian, 'width' => '715px', 'colspan'=>'4',  'style' => ' border-right: 1px solid black; text-align:left;font-style: italic;'),
																		 array('data' => apbd_fn($dataro->jumlahx),  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;font-style: italic;'),
																		 );	
	...
	$rowsrek[] = array (
						 array('data' => 'SURPLUS / DEFISIT',  'width'=> '775px',  'colspan'=>'5',  'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 array('data' => apbd_fn($totalp-$totalb),  'width' => '100px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; text-align:right; font-weight:bold;'),
						 );	
	...
	if ($kodeuk=='00') {
		...
		$rowsrek[] = array (
							 array('data' => '6',  'width'=> '60px', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:left;'),
							 array('data' => 'PEMBIAYAAN', 'width' => '715px', 'colspan'=>'4',  'style' => ' border-right: 1px solid black; text-align:left;font-weight:bold;'),
							 array('data' => '',  'width' => '100px', 'style' => ' border-right: 1px solid black; text-align:right;'),
							 );
		...
		$rowsrek[] = array (
							 array('data' => 'SISA LEBIH ANGGARAN TAHUN BERKENAAN',  'width'=> '775px',  'colspan'=>'5',  'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; text-align:right; font-weight:bold;'),
		...
		if ($tipedok=='dpa') {
		$rowsrek[] = array (
							 array('data' => 'Rencana Pelaksanaan Anggaran Satuan Kerja Perangkat Daerah per SKPD',  'width'=> '875px', 'colspan'=>'6', 'style' => 'border-left: 1px solid black;  border-right: 1px solid black; text-align:center;'),
							 );
		$rowsrek[] = array (
							 array('data' => 'No',  'width'=> '35px','rowspan'=>'2',  'style' => 'border-top: 1px solid black;  border-left: 1px solid black;  text-align:center;'),
							 array('data' => 'Uraian',  'width'=> '240px', 'rowspan'=>'2',  'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:center;'),
							 array('data' => 'Triwulan',  'width'=> '600px', 'colspan'=>'4',  'style' => 'border-top: 1px solid black; border-left: 1px solid black;  border-right: 1px solid black; text-align:center;'),
							 );
		$rowsrek[] = array (
							 array('data' => 'I',  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:center;'),
							 array('data' => 'II',  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:center;'),
							 array('data' => 'III',  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:center;'),
							 array('data' => 'IV',  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black; border-right: 1px solid black; text-align:center;'),
							 );
		/*
		$where = ' and kodeuk=\'%s\'';
		$pquery = sprintf('select sum(pajak+retribusi+hpkd+padlain) tw from {anggkaspendapatan} where bulan in (1,2,3) ' . $where, db_escape_string($kodeuk));
		...
		*/
		...
		if ($kodeuk=='00') {
			$fsql = 'select sum(jumlah) jumlahx from {anggperuk} ';
		} else {
			$where = ' where a.kodeuk=\'%s\' and left(a.kodero,2)=\'%s\'';
			$sql = 'select sum(a.jumlah) jumlahx from {anggperuk} a inner join {rincianobyek} r on a.kodero=r.kodero ' . $where;
		...
		if ($data = db_fetch_object($res)) {
			$tw = round($data->jumlahx/4000,0);
			//drupal_set_message($tw);
			$tw1 = $tw * 1000;
			$tw2 = $tw1;
			$tw3 = $tw1;
		...
		$rowsrek[] = array (
							 array('data' => '4',  'width'=> '35px', 'style' => 'border-top: 1px solid black;  border-left: 1px solid black; text-align:left;'),
							 array('data' => 'Pendapatan',  'width'=> '240px',  'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:left;'),
							 array('data' => apbd_fn($tw1),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:right;'),
							 array('data' => apbd_fn($tw2),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:right;'),
							 array('data' => apbd_fn($tw3),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:right;'),
							 array('data' => apbd_fn($tw4),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  border-right: 1px solid black; text-align:right;'),
							 );
		...
		$tw3 = 0;
		$tw4 = 0;
		if ($kodeuk!='00') $where = sprintf(' and kodeuk=\'%s\'', db_escape_string($kodeuk));
		$pquery = 'select sum(tw1) tw1t,sum(tw2) tw2t,sum(tw3) tw3t,sum(tw4) tw4t from {kegiatanskpd} where jenis=1 ' . $where;
		//drupal_set_message($pquery);
		$pres = db_query($pquery);
		if ($data = db_fetch_object($pres)) {
			$tw1 = $data->tw1t;
		...
		$rowsrek[] = array (
							 array('data' => '5.1',  'width'=> '35px', 'style' => 'border-top: 1px solid black;  border-left: 1px solid black; text-align:left;'),
							 array('data' => 'Belanja Tidak Langsung',  'width'=> '240px',  'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:left;'),
							 array('data' => apbd_fn($tw1),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:right;'),
							 array('data' => apbd_fn($tw2),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:right;'),
							 array('data' => apbd_fn($tw3),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:right;'),
							 array('data' => apbd_fn($tw4),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  border-right: 1px solid black; text-align:right;'),
		...
		$tw3 = 0;
		$tw4 = 0;
		$pquery = 'select sum(tw1) tw1t,sum(tw2) tw2t,sum(tw3) tw3t,sum(tw4) tw4t from {kegiatanskpd} where jenis=2 and total>0 and inaktif=0 ' . $where;
		//drupal_set_message($pquery);
		$pres = db_query($pquery);
		if ($data = db_fetch_object($pres)) {
			$tw1 = $data->tw1t;
		...
		$rowsrek[] = array (
							 array('data' => '5.2',  'width'=> '35px', 'style' => 'border-top: 1px solid black;  border-left: 1px solid black;  text-align:left;'),
							 array('data' => 'Belanja Langsung',  'width'=> '240px',  'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:left;'),
							 array('data' => apbd_fn($tw1),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:right;'),
							 array('data' => apbd_fn($tw2),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:right;'),
							 array('data' => apbd_fn($tw3),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  text-align:right;'),
							 array('data' => apbd_fn($tw4),  'width'=> '150px', 'style' => 'border-top: 1px solid black; border-left: 1px solid black;  border-right: 1px solid black; text-align:right;'),
		...
		$rowsrek[] = array (
							 array('data' => '',  'width'=> '35px', 'style' => 'border-top: 1px solid black;  text-align:left;'),
							 array('data' => '',  'width'=> '240px',  'style' => 'border-top: 1px solid black;  text-align:left;'),
							 array('data' => '',  'width'=> '150px', 'style' => 'border-top: 1px solid black; text-align:right;'),
							 array('data' => '',  'width'=> '150px', 'style' => 'border-top: 1px solid black; text-align:right;'),
							 array('data' => '',  'width'=> '150px', 'style' => 'border-top: 1px solid black; text-align:right;'),
							 array('data' => '',  'width'=> '150px', 'style' => 'border-top: 1px solid black; text-align:right;'),
							 );
...
function GenReportFormFooter($kodeuk, $tipedok) {
	...
	if ($tipedok=='dpa') {
		...
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '575px',  'colspan'=>'2',  'style' => 'text-align:center'),
							 array('data' => 'Jepara, ' . $dpatgl,  'width' => '300px', 'style' => 'text-align:center;'),
							 );
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '575px',  'colspan'=>'2',  'style' => 'text-align:center'),
							 array('data' => 'Menyetujui,',  'width' => '300px', 'style' => 'text-align:center;'),
							 );
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '575px',  'colspan'=>'2',  'style' => 'text-align:center'),
							 array('data' => $setdajabatan,  'width' => '300px', 'style' => 'text-align:center;'),
							 );
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '575px',  'colspan'=>'2',  'style' => 'text-align:center'),
		...
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '575px',  'colspan'=>'2',  'style' => 'text-align:center'),
							 array('data' => $setdanama,  'width' => '300px', 'style' => 'text-align:center; text-decoration: underline;'),
							 );
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '575px',  'colspan'=>'2',  'style' => 'text-align:center'),
							 array('data' => 'NIP. ' . $setdanip,  'width' => '300px', 'style' => 'text-align:center;'),
							 );		
	...
	//DPA	
		...
		$rowsfooter[] = array (
							 array('data' => 'CATATAN',  'width'=> '575px',  'colspan'=>'2',  'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; text-align:center'),
							 array('data' => $pimpinanjabatan,  'width' => '300px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
							 );
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '575px',  'colspan'=>'2',  'style' => 'border-left: 1px solid black; border-right: 1px solid black; text-align:center'),
							 array('data' => '',  'width' => '300px', 'style' => 'border-right: 1px solid black; text-align:right;'),
							 );
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '575px',  'colspan'=>'2',  'style' => 'border-left: 1px solid black; border-right: 1px solid black; text-align:center'),
							 array('data' => '',  'width' => '300px', 'style' => 'border-right: 1px solid black; text-align:right;'),
		...
		$rowsfooter[] = array (
							 array('data' => '',  'width'=> '575px',  'colspan'=>'2',  'style' => 'border-left: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; text-align:center'),
							 array('data' => 'NIP. ' . $pimpinannip,  'width' => '300px', 'style' => 'border-bottom: 1px solid black; border-right: 1px solid black; text-align:center;'),
							 );
	}
