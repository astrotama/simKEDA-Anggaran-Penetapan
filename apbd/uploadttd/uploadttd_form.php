...
//...............................................................................
    ...
    if ($e_username=='')
    {
        ...
        $sql = 'update {apbdop} set nama=\'%s\', kodeuk=\'%s\', kodesuk=\'%s\', ttd=\'%s\' where username=\'%s\' ';
        $res = db_query(db_rewrite_sql($sql), array(strtoupper($nama), strtoupper($kodeuk), strtoupper($kodesuk),$fileurl, $e_username));
    }
	if ($user) {
		//$perm = apbd_perm();
